    ...
    >
      ...
      >
        <div>
          ...
          >
            Giải phóng tiềm năng của bạn và bắt đầu hành trình hướng tới một con
            người mạnh mẽ, khỏe khoắn và tự tin hơn. Đăng ký ngay hôm nay và
            chứng kiến sự thay đổi tuyệt vời mà cơ thể bạn có thể đạt được!
          </p>
          <Link
            to="/login"
            style={pageStyles.btn}
      ...
      <section id="chuong-trinh" style={pageStyles.section}>
        ...
        <p style={pageStyles.sectionSubtitle}>
          Khám phá các chương trình tập luyện đa dạng được thiết kế phù hợp với
          mọi cấp độ từ người mới bắt đầu đến VĐV chuyên nghiệp
        </p>
        <div style={pageStyles.cardGrid}>
          <div
            ...
            onMouseOver={(e) => {
              ...
              e.currentTarget.style.boxShadow =
                '0 12px 40px rgba(249, 172, 84, 0.3)';
            }}
            onMouseOut={(e) => {
          ...
          >
            ...
            <p style={{ color: '#d1d5db', lineHeight: '1.6' }}>
              Xây dựng cơ bắp và tăng sức mạnh với các bài tập tạ và máy tập
              hiện đại
            </p>
          </div>
          <div
      ...
      <section id="dich-vu" style={pageStyles.section}>
        ...
        <div style={pageStyles.cardGrid}>
          <div style={pageStyles.card}>
            ...
            <p style={{ color: '#d1d5db', lineHeight: '1.6' }}>
              Được hướng dẫn 1-1 bởi các HLV chuyên nghiệp với chương trình cá
              nhân hóa
            </p>
          </div>
          <div style={pageStyles.card}>
      ...
      <section id="gioi-thieu" style={pageStyles.section}>
        ...
        >
          <div>
            ...
            >
              Chúng tôi là một trong những phòng tập hàng đầu với đội ngũ huấn
              luyện viên chuyên nghiệp, trang thiết bị hiện đại và không gian
              tập luyện thoải mái.
            </p>
            <div
              style={{
      ...
      <section id="cong-dong" style={pageStyles.section}>
        ...
        <p style={pageStyles.sectionSubtitle}>
          Kết nối với hàng nghìn thành viên khác, chia sẻ kinh nghiệm và cùng
          nhau chinh phục mục tiêu sức khỏe
        </p>
        <div
          style={{
            backgroundColor: 'rgba(31, 33, 37, 0.9)',
      ...
      >
        <p>
          Bản quyền © 2024 Hệ thống quản lý phòng tập. Mọi quyền được bảo lưu.
        </p>
      </footer>
    </div>
  );
