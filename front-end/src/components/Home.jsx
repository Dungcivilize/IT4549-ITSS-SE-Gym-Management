...
function Home() {
  return (
    <>
      ...
      <header className={`${styles.section__container} ${styles.header__container}`}>
      ...
      <section className={`${styles.section__container} ${styles.explore__container}`}>
        ...
        <div className={styles.explore__grid}>
          ...
          <ExploreCard
            ...
            title="Weight Gain"
            description="Designed for individuals..."
          />
        </div>
      </section>

      <section className={`${styles.section__container} ${styles.class__container}`}>
        <div className={styles.class__image}>
          <span className={styles.bg__blur}></span>
          <img
            src={class1}
            alt="class"
            className={styles.class__img_1}
          />
        </div>
        <div className={styles.class__content}>
          <h2 className={styles.section__header}>THE CLASS YOU WILL GET HERE</h2>
      ...
      <section className={`${styles.section__container} ${styles.join__container}`}>
        <h2 className={styles.section__header}>WHY JOIN US ?</h2>
        <p className={styles.section__subheader}>Our diverse membership base...</p>
      ...
      <section className={`${styles.section__container} ${styles.price__container}`}>
      ...
      <footer className={`${styles.section__container} ${styles.footer__container}`}>
        <span className={styles.bg__blur}></span>
